...
public class StatisticsPanel extends javax.swing.JPanel {
    ...
    public StatisticsPanel() {
        ...
        cbxMonth4.setSelectedIndex(month - 1);
    ...
    private void initComponents() {
        ...
        cbxMonth4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tháng 1", "Tháng 2", "Tháng 3", "Tháng 4", "Tháng 5", "Tháng 6", "Tháng 7", "Tháng 8", "Tháng 9", "Tháng 10", "Tháng 11", "Tháng 12" }));
...
//   System.out.println(cbxMonth4.getSelectedIndex());
        DefaultTableModel tblmodel = (DefaultTableModel) tblTurnover.getModel();
        tblmodel.setRowCount(0);
        String month = String.valueOf(cbxMonth4.getSelectedIndex() + 1);
